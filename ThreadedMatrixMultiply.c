...
int calculationCount = 0; //ADDED
pthread_mutex_t mutex = PTHREAD_MUTEX_INITIALIZER; //ADDED
...
int main() {
    ...
    printf("Number of Calculations by all threads: %d\n", calculationCount); //ADDED
